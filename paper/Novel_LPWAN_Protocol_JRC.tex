...
\begin{verbatim}
# Clone and setup
git clone https://github.com/vokasitibrawijaya/
    novel-lpwan-protocol.git
cd novel-lpwan-protocol
pip install -r requirements.txt

# Run single experiment
python simulation/run_sim.py \
    --config configs/ieee_experiments/cmd_ctrl_001.yaml

# Run full sweep (660 configurations)
